...
export interface ApiBoletinBoletin extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    archivo: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
...
export interface ApiColaboradorColaborador extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    resenia: Schema.Attribute.Text & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiConvenioConvenio extends Struct.CollectionTypeSchema {
...
export interface ApiDirectorioOrgDirectorioOrg extends Struct.SingleTypeSchema {
  collectionName: 'directorio_orgs';
  info: {
    displayName: 'Directorio-org';
    pluralName: 'directorio-orgs';
    singularName: 'directorio-org';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::directorio-org.directorio-org'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiDirectorioDirectorio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imagen: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    imagen_empresa: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiEquipoEquipo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    area: Schema.Attribute.Enumeration<
      [
        '\u00C1rea de Asuntos Legales y Administrativos',
...
export interface ApiMemoriaMemoria extends Struct.CollectionTypeSchema {
  collectionName: 'memorias';
  info: {
    displayName: 'Memoria';
    pluralName: 'memorias';
    singularName: 'memoria';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMensajeMensaje extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    asunto: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNoticiaTransporteNoticiaTransporte
  extends Struct.CollectionTypeSchema {
  collectionName: 'noticia_transportes';
  info: {
    displayName: 'Noticia-transporte';
    pluralName: 'noticia-transportes';
    singularName: 'noticia-transporte';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::noticia-transporte.noticia-transporte'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titulo: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiPoliticaPrivacidadPoliticaPrivacidad
  extends Struct.SingleTypeSchema {
  collectionName: 'politica_privacidads';
  info: {
    displayName: 'Politica-privacidad';
    pluralName: 'politica-privacidads';
    singularName: 'politica-privacidad';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::politica-privacidad.politica-privacidad'
    > &
      Schema.Attribute.Private;
    politica: Schema.Attribute.RichText & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRedSocialRedSocial extends Struct.CollectionTypeSchema {
  collectionName: 'red_socials';
  info: {
    displayName: 'Red-social';
    pluralName: 'red-socials';
  ...
  attributes: {
    ...
    proveedor: Schema.Attribute.Enumeration<
...
export interface ApiSolicitudMembresiaSolicitudMembresia
  extends Struct.CollectionTypeSchema {
  collectionName: 'solicitud_membresias';
  info: {
    displayName: 'Solicitud-membresia';
    pluralName: 'solicitud-membresias';
    singularName: 'solicitud-membresia';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::solicitud-membresia.solicitud-membresia'
    > &
      Schema.Attribute.Private;
    mail: Schema.Attribute.Email & Schema.Attribute.Required;
    nombre_o_razon_social: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    representante_legal: Schema.Attribute.String & Schema.Attribute.Required;
    rut: Schema.Attribute.String & Schema.Attribute.Required;
    tamano_flota: Schema.Attribute.String & Schema.Attribute.Required;
    telefono: Schema.Attribute.String & Schema.Attribute.Required;
    tipo_socio: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTestimonioTestimonio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nombre_empresa: Schema.Attribute.String & Schema.Attribute.Required;
    publico: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::directorio-org.directorio-org': ApiDirectorioOrgDirectorioOrg;
      'api::directorio.directorio': ApiDirectorioDirectorio;
      'api::equipo.equipo': ApiEquipoEquipo;
      'api::memoria.memoria': ApiMemoriaMemoria;
      'api::mensaje.mensaje': ApiMensajeMensaje;
      'api::noticia-transporte.noticia-transporte': ApiNoticiaTransporteNoticiaTransporte;
      'api::noticia.noticia': ApiNoticiaNoticia;
      'api::politica-privacidad.politica-privacidad': ApiPoliticaPrivacidadPoliticaPrivacidad;
      'api::red-social.red-social': ApiRedSocialRedSocial;
      'api::solicitud-membresia.solicitud-membresia': ApiSolicitudMembresiaSolicitudMembresia;
